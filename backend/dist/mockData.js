...
exports.MOCK_ARTICLES = exports.MOCK_SOURCES = exports.MOCK_CATEGORIES = void 0;
...
function generateRichContent(title, summary) {
...
const rawArticles = [];
exports.MOCK_ARTICLES = rawArticles.map(a => {
    const category = exports.MOCK_CATEGORIES.find(c => c.slug === a.categorySlug) || exports.MOCK_CATEGORIES[0];
    const source = exports.MOCK_SOURCES.find(s => s.name === a.sourceName) || exports.MOCK_SOURCES[0];
    return {
        id: a.id,
        title: a.title,
        summary: a.summary,
