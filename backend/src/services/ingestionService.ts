...
import { summarizeArticle, generateDailyBrief } from './aiService';

// List of trusted RSS feed configurations covering all categories
 ...
 */
/**
 * Hashing utility to generate a deterministic integer from a string
 */
 ...
 * Returns a high-quality static Unsplash photo ID matching the category theme from a pool
 */
export function getCategoryPlaceholderImage(category: string, title: string): string {
  const pools: Record<string, string[]> = {
    'AI & Technology': [
      ...
      '1618005182384-a83a8bd57fbe', '1531297484001-80022131f5a1', '1639762688036-44882bd69f4a', '1620712943543-bcc4688e7485', '1581091226825-a6a2a5aee158'
    ],
    'Startups': [
      ...
      '1515378791036-0648a3ef77b2', '1531482615713-2afd69097998', '1552664730-d307ca884978', '1522202188-0df37074a80d', '1573497019940-1c28c88b4f3e'
    ],
    'Business': [
      ...
      '1434626881859-194d67b2b86f', '1542744173-05336fcc7ad4', '1664575600397-88e360cb7d3a', '1557804506-669a67965ba0', '1486406146926-c627a92ad1ab'
    ],
    'Stock Market': [
      ...
      '1559526324-4b87b5e36f44', '1611974789855-9c2a0a7236a3', '1642390061122-f57ec7610050', '1526304640581-d334cdbbf45e', '1611974500912-fbc87be2e1ce'
    ],
    'Cryptocurrency': [
      ...
      '1621416894569-0f39ed31d377', '1622630998152-f3a97504f553', '1639762688036-44882bd69f4a', '1629084594539-786d790d0b0a', '1621761191319-c6fb62004040'
    ],
    'Politics': [
      ...
      '1541872703-74c5e44368f9', '1505664194762-c1e3027a0064', '1540910419-a9a7e68404b5', '1529107386315-e1a2ed48a620', '1569974498888-af76a6d4b29b'
    ],
    'Science': [
      ...
      '1532187643603-ba119ca4109e', '1451187580459-43490279c0fa', '1576086213309-99a88910bc48', '1607604276583-eef5d076aa5f', '1507668077129-56e32842fceb'
    ],
    'Global Affairs': [
      ...
      '1526304640581-d334cdbbf45e', '1521295121773-6a31729398f2', '1508849789987-4e5333c12b78', '1479812435906-ac12e47229e6', '1596495578065-6e0763fa1178'
    ],
    'Economy': [
      ...
      '1544377193-33dcf4d68fb5', '1526304899543-c0d16453715c', '1611974789855-9c2a0a7236a3', '1559526324-4b87b5e36f44', '1526304640581-d334cdbbf45e'
    ],
    'Personal Finance': [
      ...
      '1579621970220-fd276f780e22', '1554224155-8d04cb21cd6c', '1563986768-9a98c8c253b6', '1507679799987-c73779587ccf', '1559526324-4b87b5e36f44'
    ],
    'Jobs': [
 ...
 */
export async function fetchUnsplashPhotoId(query: string): Promise<string | null> {
  try {
 ...
 */
async function fetchGNewsArticles(apiKey: string): Promise<any[]> {
  const categories = [
...
export async function ingestNews() {
  ...
  for (const rawArt of rawArticlesToIngest) {
    ...
    if (!image) {
      image = getCategoryPlaceholderImage(category, title);
    }
    ...
    try {
      ...
      (async () => {
        await summarizeArticle(newArticle.id);
        const { verifyArticle } = await import('./verificationService');
        await verifyArticle(newArticle.id);
      })().catch(err =>
        console.error(`⚠️  AI pipeline failed for article ${newArticle.id}:`, err.message)
      );
    } catch (e) {
...
export function startScheduler() {
  ...
  cron.schedule('0 6 * * *', async () => {
    ...
    const brief = await generateDailyBrief(new Date());
    if (brief) {
